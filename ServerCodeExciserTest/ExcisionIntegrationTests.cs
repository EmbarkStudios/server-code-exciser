...
{
    private static readonly string TestProblemPath = @"Problems";
    //private static string TestProblemPath = @"ProblemTestBed"; 
    private static readonly string TestAnswerPath = @"Answers";
    private static readonly string TestSolutionPath = @"Solutions";

    private static readonly string CommonSubPath = @"Common";
    private static readonly string AngelscriptSubPath = @"Angelscript";
    ...
    private static bool RunExciserIntegrationTests(string fileExtension, string testProblemPath, string testAnswerPath, string testSolutionPath, string commonProblemPath, string commonSolutionPath, ref int nrCorrectAnswers, ref int nrErrors, ref int nrProblems)
    {
        ...
        var excisionReturnCode = (EExciserReturnValues)ServerCodeExciserProgram.Main(exciserArgs);
